            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative mx-auto max-w-5xl">
                    ...
                    <div className="bg-card border shadow-lg rounded-2xl p-2 sm:p-4">
                       <AiImage data-ai-id="app-screenshot" data-ai-hint="pharmacy education app interface" alt="A2G Smart Notes App in action" width={1200} height={675} className="rounded-lg" />
                    </div>
                </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex justify-center">
                        <AiImage data-ai-id="founder-portrait" data-ai-hint="professional indian man portrait" alt="Arvind Sharma, Founder of A2G Smart Notes" width={400} height={400} className="rounded-full shadow-lg" />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    <Card className="bg-background">
                        <CardContent className="p-6">
                            ...
                            <div className="flex items-center gap-4 mt-4">
                                <AiImage data-ai-id="testimonial-avatar-priya" data-ai-hint="indian female student" alt="User avatar" width={40} height={40} className="rounded-full" />
                                <div>
                    ...
                    <Card className="bg-background">
                        <CardContent className="p-6">
                            ...
                            <div className="flex items-center gap-4 mt-4">
                                <AiImage data-ai-id="testimonial-avatar-rahul" data-ai-hint="indian male student" alt="User avatar" width={40} height={40} className="rounded-full" />
                                <div>
                    ...
                    <Card className="bg-background">
                        <CardContent className="p-6">
                            <p className="text-muted-foreground italic">"The premium subscription is worth every rupee. The detailed notes and follow-up question feature gave me the confidence I needed."</p>
                             <div className="flex items-center gap-4 mt-4">
                                <AiImage data-ai-id="testimonial-avatar-anjali" data-ai-hint="smiling indian woman" alt="User avatar" width={40} height={40} className="rounded-full" />
                                <div>
