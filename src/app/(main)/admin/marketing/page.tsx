        ...
        <div className="pt-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                      This is a list of all users who have subscribed to your newsletter from the landing page. A total of {subscribers.length} {subscribers.length === 1 ? 'user has' : 'users have'} subscribed.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {loading ? (
