    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="w-64 bg-white shadow-md p-6 flex flex-col">
        ...
        <nav className="space-y-3 text-gray-700">
          ...
          <a href="/dashboard/ai-notes" className="block p-2 rounded hover:bg-gray-200">📝 AI Notes Generator</a>
          <a href="/dashboard/ai-mcq-generator" className="block p-2 rounded hover:bg-gray-200">❓ AI MCQ Generator</a>
          ...
          <a href="/dashboard/premium" className="block p-2 rounded hover:bg-gray-200">⭐ Premium Plans</a>
