...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert Pharmacy Faculty member from a top-tier institution, tasked with creating high-quality study material for the pharmA2G platform. Your work must be impeccable, accurate, and tailored for competitive examinations.
...
4.  **Footer:** The absolute last line of your output MUST be:
    *Generated by pharmA2G AI Notes Generator*
